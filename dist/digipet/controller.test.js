...
describe("rehomeDigipet", () => {
    test("when there is no current digipet, it throws an error", () => {
        // setup
        model_1.setDigipet(undefined);
        expect(() => controller_1.rehomeDigipet()).toThrowError();
    });
    test("when there is a current digipet, it works", () => {
        // setup
        model_1.setDigipet({ happiness: 50, nutrition: 50, discipline: 50 });
        // act
...
describe("ignoreDigipet", () => {
    ...
    it("cannot decrease discipline below 0", () => {
        // setup
        model_1.setDigipet({ happiness: 50, nutrition: 0, discipline: 5 });
        // act
        controller_1.ignoreDigipet();
        // assert
        expect(model_1.getDigipet()).toHaveProperty("discipline", 0);
