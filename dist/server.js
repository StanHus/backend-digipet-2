...
app.get("/digipet/rehome", (req, res) => {
    ...
    if (digipet) {
        ...
        res.json({
            message: "You have successfully rehomed your digipet. Now you have a space for a new one",
            digipet,
        });
    }
    else {
...
app.get("/digipet/ignore", (req, res) => {
    ...
    if (model_1.getDigipet()) {
        ...
        res.json({
            message: "You don't have a digipet to ignore (thank god)! Try hatching one with /digipet/hatch",
        });
    }
});
exports.default = app;
